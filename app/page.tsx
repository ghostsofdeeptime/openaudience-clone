    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          <div className="nav-group"><a href="/event-technology/">Products &amp; Services</a><div className="dropdown"><div className="subgroup"><a href="/event-technology/products/">Products <span>&rsaquo;</span></a><div className="flyout"><a href="/openmeet/">OpenMeet</a><a href="/openvod/">OpenVOD</a><a href="/opentube/">OpenTube</a></div></div><a href="/event-technology/services/">Services</a></div></div>
          <a href="/event-technology/solutions/">Solutions</a>
          <a href="/events/life-sciences/">Life Sciences</a>
          <div className="nav-group"><a href="#">More</a><div className="dropdown"><a href="/sustainability-at-open-audience/">Sustainability at Open Audience</a><a href="/blog/">Blog</a><a href="/case-studies/">Case Studies</a></div></div>
      ...
      <footer>
        ...
        <div className="copyright section">© Open Audience 2024</div>
      </footer>
